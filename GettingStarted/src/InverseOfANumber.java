...
public class InverseOfANumber {
	...
	// example 13542 for 32415
	public static void main(String[] args) {
		Scanner scn = new Scanner(System.in);
		int n = scn.nextInt(); // (32415)
		scn.close();
		int count = 0;
		int inverse = 0;
		while (n != 0) {
			int q = n % 10; // (5 for 32415)
			count++;
			int place = (int) Math.pow(10, q - 1); // (10000 for 32415)
			int res = count * place; // (10000 for 32415)
			inverse = inverse + res; // (10000 for 32415)
			n = n / 10; // (3241 for 32415)
		}
